...
public class GameBoard extends GridPane {
    ...
    private BlockHoverListener blockHoverListener;
    ...
    protected GameBlock createBlock(int x, int y) {
        ...
        block.setOnMouseEntered(event -> blockHover(event,block));
     ...
     * @param listener the listener to listen for a right click event
     */
    ...
    /**
     * Set the block hover listener to handle an event when a block is hovered over
     * @param listener the listener to listen for a block hover event
     */
    public void setOnBlockHovered(BlockHoverListener listener){
        this.blockHoverListener=listener;
    }
     ...
     * @param event mouse event
     * @param block aimed at
     */
    private void blockHover(MouseEvent event, GameBlock block){
        logger.debug("Block hovered over: {}", block);
        if(blockHoverListener != null) {
            blockHoverListener.blockHover(block);
        }
    }

    /**
     * Triggered when a block is right-clicked. Call the attached listener.
     * @param block the block right-clicked
     */
    ...
    /**
     * Calls fadeOut GameBlock method for all game blocks in the hash set
     * @param gameBlockCoordinates the blocks to fade out
     */
    public void fadeOut(HashSet<GameBlockCoordinate> gameBlockCoordinates){
        for (GameBlockCoordinate coords : gameBlockCoordinates){
            getBlock(coords.getX(),coords.getY()).fadeOut();
        }
    }
